  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.addEventListener('click', (e) => {
        ...
        for (const el of p) {
          if (el === root) break;
          if (el.classList && (el.classList.contains('ctl') || el.classList.contains('spill') || el.classList.contains('empty') || el.classList.contains('handle'))) { e.stopPropagation(); break; }
        }
      });
      root.addEventListener('pointerdown', (e) => {
        ...
        for (const el of p) {
          if (el === root) break;
          if (el.classList && (el.classList.contains('ctl') || el.classList.contains('spill') || el.classList.contains('handle'))) { e.stopPropagation(); break; }
        }
      });
      root.addEventListener('click', (e) => {
    ...
    handleEvent(e) {
      if (!this.hasAttribute('data-editable')) return; // read-only outside the editor
